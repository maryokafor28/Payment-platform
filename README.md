...
The rest of the platform exists at the design level for now. Full architecture, database schema, and system flows for every planned service are documented in the [System Design Document](src/docs/payment-platform-system-design-v1.md).
